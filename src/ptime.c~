 ...
 */
long
tspec_to (const tspec * t, int unit)
{
  long tu;
 ...
 */
long
tspec_to_rel (const tspec * t, int unit)
{
  long tu;
 ...
 */
tspec
tspec_from_rel (long tu, int unit)
{
  tspec t;
...
tspec
tspec_add (const tspec * a, const tspec * b)
{
  tspec s;
 ...
 */
int
tspec_cmp (const tspec * a, const tspec * b)
{
...
tspec
tspec_sub (const tspec * a, const tspec * b)
{
  tspec d;
